...
//        positiveAction.setEnabled(false); // disabled by default
     ...
     * @return MaterialDialog.Builder
     */
    public static void showOpenAppSettingDialog(final Context context) {

       new MaterialDialog.Builder(context)
                .title("注意")
               .titleGravity(GravityEnum.START)
               .content("我们需要一些您拒绝或系统授权失败的权限，请手动设置为页面授权，否则该功能将无法正常使用！")
//                .customView(content, true)
                .positiveText("设置")
                .negativeText("取消")
    ...
    /***
     * 授权成功后手动关闭权限后 再次授权确认弹框
     *
     * @param
     * @return MaterialDialog.Builder
     */
    public static void showRationaleDialog(final Context context,final PermissionUtils.OnRationaleListener.ShouldRequest shouldRequest) {

        new MaterialDialog.Builder(context)
                .title("注意")
                .titleGravity(GravityEnum.START)
                .content("您已拒绝我们申请授权，请同意授权，否则该功能将无法正常使用！")
                .positiveText("授权")
                .negativeText("取消")
                .onNegative(new MaterialDialog.SingleButtonCallback() {
                    @Override
